...
import com.example.bank_api.repositories.InsertUserRepository;
...
public class BalanceOperation {
    ...
    public BalanceOperation(InsertUserRepository insertUserRepository, UserRepository userRepository) {
